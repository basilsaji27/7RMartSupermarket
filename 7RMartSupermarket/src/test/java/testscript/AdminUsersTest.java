...
public class AdminUsersTest extends Base {
	...
	public void verifyAbleToCreateNewAdminUser() throws IOException {
		...
		adminuserspage.clickNewActionBtnForAdminUsers().enterUsernameInAdminUsersInformations(adminusername)
				.enterPasswordInAdminUsersInformations(adminpassword).selectUserTypeInAdminUsersInformations("partner")
				.clickSaveBtnInAdminUsers();
		/*
