...
public class ManageCategoryTest extends Base {
	...
	public void addNewCategory() throws IOException {
		...
		managecategorypage = logoutpage.clickingMoreInfoForManageCategory().clickingNewInManageCategory()
				.addCategoryName(categoryName).selectCategoryGroup().categoryImageUpload().clickingSavebtn();
		/*
