...
public class ManageFooterTextTest extends Base {
	...
	public void verifyAbleToManageFooterDetails() throws Exception {
		...
		managefootertextpage.clickingFooterTextActionBtn().clickingAddressFieldinFooterTextInformationsPage(newAddress)
				.clickingEmailFieldinFooterTextInformationsPage(newEmail)
				.clickingPhoneFieldinFooterTextInformationsPage(newPhone)
				.clickingUpdateBtninFooterTextInformationsPage();
		/*
		 * managefootertextpage.clickingAddressFieldinFooterTextInformationsPage(
		 * newAddress);
	...
	public void verifyUpdateButtonIsAvailableInManageFooterDetails() throws IOException, Exception {
		String username = ExcelUtility.getStringData(1, 0, "LoginPage");
		String password = ExcelUtility.getStringData(1, 1, "LoginPage");
		LoginPage loginpage = new LoginPage(driver);
		loginpage.enterUserName(username).enterPassword(password);
