...
public class ManageFooterTextPage {
	...
	// @class='small-box-footer'] ") WebElement moreInfoManageFooterText;
	@FindBy(xpath = "//a[@href='https://groceryapp.uniqassosiates.com/admin/Footertext/edit?edit=2']")
	WebElement manageFooterTextActionBtn2;
	@FindBy(id = "content")
	WebElement manageFooterTextAddressField;
	@FindBy(id = "email")
	WebElement manageFooterTextEmailField;
	@FindBy(id = "phone")
	WebElement manageFooterTextPhoneField;
	@FindBy(xpath = "//button[@name='Update']")
	WebElement manageFooterTextUpdateBtn;
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	WebElement manageFooterTextSuccessAlertPopup;
