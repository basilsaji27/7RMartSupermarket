...
public class AdminUsersPage {
	...
	// @FindBy(xpath = "//a[@class='small-box-footer' and
	// @href='https://groceryapp.uniqassosiates.com/admin/list-admin']") WebElement
	// moreInfoForAdminUsers;
	@FindBy(xpath = "//a[@onclick='click_button(1)']")
	WebElement newActionBtnAdminUsers;
	@FindBy(id = "username")
	WebElement usernameFieldAdminUsers;
	@FindBy(id = "password")
	WebElement passwordFieldAdminUsers;
	@FindBy(id = "user_type")
	WebElement userTypeFieldAdminUsers;
	@FindBy(xpath = "//button[@name='Create']")
	WebElement saveBtnAdminUsers;
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	WebElement alertUserCreatedSuccess;
	...
	/*
	 * public void clickMoreInfoForAdminUsers() { moreInfoForAdminUsers.click(); }
	 */
