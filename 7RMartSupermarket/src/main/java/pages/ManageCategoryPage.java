...
public class ManageCategoryPage {
	...
	/*
	 * public void clickingMoreInfoForManageCategory() { PageUtility pageUtility =
	 * new PageUtility(); pageUtility.jsClick(driver, moreInfoForManageCategory); }
	 */
